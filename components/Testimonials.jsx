            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 dark:bg-gray-700 p-8 rounded">
                <svg
                  ...
                  fill="currentColor"
                  className="block w-5 h-5 text-gray-400 dark:text-gray-300 mb-4"
                ...
                <p className="leading-relaxed mb-6">
                  Ayush's core strength is his ability to adapt and apply
                  critical thinking to a problem. He doesn't just take a project
                  and do it, he will break it down, check it ticks all the boxes
                  (including the ones you forgot about!), and then deliver
